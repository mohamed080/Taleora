...
export function TopRatedBooks() {
  ...
  return (
    <section className="text-center px-4">
      <Button variant="link" size="lg" className="px-7 py-5 rounded-full mb-10">
        <IoMdTrophy />
        {t("title")}
      </Button>
      ...
      <p className="text-gray font-medium text-xl mb-5 text-center">
        {t("subtitle")}
      </p>
                      ...
                      >
                        ...
                        <div className="flex flex-col justify-between">
                          ...
                          <div className="text-end">
                            <Button asChild className="px-10 py-6 text-right" variant="gradient" size="lg">
                              <Link href={`/${locale}/books/${slide.id}`}>{t("personalize")}</Link>
                            </Button>
                          </div>
                          </div>
                        </div>
              ...
              {slideGroups.map((_, idx) => (
                <button
                  ...
                  className={`h-2 w-2 rounded-full transition ${
                    idx === currentSlide
                      ? "bg-secondary w-10"
                      : "bg-secondary/45 hover:bg-secondary/80"
                  }`}
