...
export function KidSection() {
  ...
  return (
    <section className="max-w-7xl mx-auto mb-18">
      <div className="grid md:grid-cols-2 gap-2 items-center">
                      ...
                      <div className="flex flex-col justify-between">
                        <div className="text-start my-8">
                          ...
                          <div className="text-end">
                            <Button
                            asChild
                              className="px-10 py-6 text-right bg-[#009FD9] [a]:hover:bg-[#009FD9]/80"
                            //   variant=""
                              size="lg"
                            >
            ...
            {slideGroups.map((_, idx) => (
              <button
                ...
                className={`h-2 w-2 rounded-full transition ${
                  idx === currentSlide
                    ? "bg-[#009FD9] w-10"
                    : "bg-[#009FD9]/45 hover:bg-[#009FD9]/80"
                }`}
        ...
        <div>
          <h1 className="text-5xl font-bold text-[#0064AB] mb-4">
            {t("kid.title")} <br />
